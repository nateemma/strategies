...
from NNPredictor_Transformer2 import NNPredictor_Transformer2
...
class NNPredict_Transformer2(NNPredict):
    plot_config = {
        'main_plot': {
            'close': {'color': 'green'},
            # 'smooth': {'color': 'teal'},
    ...
    def get_classifier(self, pair, seq_len: int, num_features: int):
        return NNPredictor_Transformer2(pair, seq_len, num_features)
