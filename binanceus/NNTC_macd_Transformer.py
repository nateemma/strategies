...
NNTC_macd_Transformer:
    This is a subclass of NNTC, which provides a framework for a trinary classifier neural network
...
class NNTC_macd_Transformer(NNTC):
    ...
    buy_nseq_dn = IntParameter(2, 6, default=3, space='buy', load=True, optimize=True)
    sell_nseq_up = IntParameter(2, 6, default=3, space='sell', load=True, optimize=True)
