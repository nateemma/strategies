...
PCA_highlow:
    ...
    This class trains the model based on detecting points which are either at the highest high or
    lowest low, with a future change coming

####################################################################################
"""


class PCA_highlow(PCA):
    ...
    # looks for points that are at/below lowest low or at/above highest (in startup window), with a change of direction
