...
from ClassifierKerasTFT import ClassifierKerasTFT

"""
####################################################################################
Predict_TFT - uses an TFT (keras) neural network to try and predict the future stock price
...
class NNPredict_kTFT(NNPredict):
    ...
    def get_classifier(self, pair, seq_len: int, num_features: int):
        predictor = ClassifierKerasTFT(pair, seq_len, num_features)
