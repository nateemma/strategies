...
class NSeq(IStrategy):
    ...
    buy_drop = DecimalParameter(0.005, 0.06, decimals=3, default=0.011, space="buy")

    buy_fisher = DecimalParameter(-1, 1, decimals=2, default=0.96, space="buy")
    ...
    trailing_stop_positive_offset = 0.389
