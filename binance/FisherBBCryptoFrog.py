...
Buy signals from FisherBB combined with other logic from CryptoFrog

'''
class FisherBBCryptoFrog(IStrategy):
                    ...
                    (
                            ...
                            (
                                # find smaller temporary dips in sideways
                                    ...
                                    |
                                    (
                                        ## if nothing else is making a buy signal, use FisherBB triggers
