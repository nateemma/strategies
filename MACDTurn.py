...
class MACDTurn(IStrategy):
    ...
    buy_period = DecimalParameter(5, 30, decimals=0, default=5, space="buy")
    buy_num_pre = IntParameter(1, 5, decimals=0, default=3, space="buy")
    buy_num_post = IntParameter(1, 5, decimals=0, default=1, space="buy")
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            dataframe['macdhist_ave'].shift(self.buy_num_pre.value + self.buy_num_post.value).notnull()
        )
