...
class MacheteV8b(IStrategy):
    ...
    buy_params = {
        "buy_enable_signal_adx_momentum": True,
        "buy_enable_signal_adx_smas": False,
        "buy_enable_signal_asdts_rockwelltrading": False,
        "buy_enable_signal_averages_strategy": True,
        "buy_enable_signal_awesome_macd": True,
        "buy_enable_signal_fisher_hull": False,
        "buy_enable_signal_gettin_moist": False,
        "buy_enable_signal_hlhb": False,
        "buy_enable_signal_macd_strategy": False,
        "buy_enable_signal_macd_strategy_crossed": False,
        "buy_enable_signal_pmax": False,
        "buy_enable_signal_quickie": True,
        "buy_enable_signal_scalp": False,
        "buy_enable_signal_simple": True,
        "buy_enable_signal_strategy001": False,
        "buy_enable_signal_technical_example_strategy": True,
        "buy_enable_signal_tema_rsi_strategy": False,
    }

    # Sell hyperspace params:
    sell_params = {
        "sell_cstp_bail_how": "roc",  
        "sell_cstp_bail_roc": -0.032,  
        "sell_cstp_bail_time": 1108,  
        "sell_cstp_bb_trailing_input": "bb_lowerband_neutral_inf",  
        "sell_cstp_threshold": -0.036,  
        "sell_cstp_trailing_max_stoploss": 0.054,  
        "sell_cstp_trailing_only_offset_is_reached": 0.06,  
    ...
    trailing_stop_positive_offset = 0.103  
    trailing_only_offset_is_reached = True  

    use_custom_stoploss = True

    # buy signal
    buy_enable_signal_awesome_macd = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_awesome_macd'], space='buy', optimize=True)
    buy_enable_signal_adx_momentum = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_adx_momentum'], space='buy', optimize=True)
    buy_enable_signal_adx_smas = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_adx_smas'], space='buy', optimize=True)
    buy_enable_signal_asdts_rockwelltrading = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_asdts_rockwelltrading'], space='buy', optimize=True)
    buy_enable_signal_averages_strategy = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_averages_strategy'], space='buy', optimize=True)
    ...
    buy_enable_signal_gettin_moist = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_gettin_moist'], space='buy', optimize=True)
    buy_enable_signal_hlhb = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_hlhb'], space='buy', optimize=True)
    buy_enable_signal_macd_strategy_crossed = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_macd_strategy_crossed'], space='buy', optimize=True)
    buy_enable_signal_macd_strategy = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_macd_strategy'], space='buy', optimize=True)
    buy_enable_signal_pmax = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_pmax'], space='buy', optimize=True)
    buy_enable_signal_quickie = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_quickie'], space='buy', optimize=True)
    buy_enable_signal_scalp = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_scalp'], space='buy', optimize=True)
    buy_enable_signal_simple = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_simple'], space='buy', optimize=True)
    buy_enable_signal_strategy001 = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_strategy001'], space='buy', optimize=True)
    buy_enable_signal_technical_example_strategy = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_technical_example_strategy'], space='buy', optimize=True)
    buy_enable_signal_tema_rsi_strategy = CategoricalParameter([True, False], default=buy_params['buy_enable_signal_tema_rsi_strategy'], space='buy', optimize=True)
    ...
    def get_buy_signal_awesome_macd(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_awesome_macd.value == True) &
            (dataframe['macd'] > 0) &
            (dataframe['ao'] > 0) &
    ...
    def get_buy_signal_adx_momentum(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_adx_momentum.value == True) &
            (dataframe['adx'] > 25) &
            (dataframe['mom'] > 0) &
    ...
    def get_buy_signal_adx_smas(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_adx_smas.value == True) &
            (dataframe['adx'] > 25) &
    ...
    def get_buy_signal_asdts_rockwelltrading(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_asdts_rockwelltrading.value == True) &
            (dataframe['macd'] > 0) &
    ...
    def get_buy_signal_averages_strategy(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_averages_strategy.value == True) &
    ...
    def get_buy_signal_gettin_moist(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_gettin_moist.value == True) &
            (dataframe['primed']) &
            (dataframe['moist']) &
            (dataframe['throbbing']) &
    ...
    def get_buy_signal_hlhb(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_hlhb.value == True) &
    ...
    def get_buy_signal_macd_strategy_crossed(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_macd_strategy_crossed.value == True) &
    ...
    def get_buy_signal_macd_strategy(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_macd_strategy.value == True) &
            (dataframe['macd'] > dataframe['macdsignal']) &
            (dataframe['cci'] <= -50.0)
        )
        return signal
    ...
    def get_buy_signal_pmax(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_pmax.value == True) &
    ...
    def get_buy_signal_quickie(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_quickie.value == True) &
            (dataframe['adx'] > 30) &
    ...
    def get_buy_signal_scalp(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_scalp.value == True) &
    ...
    def get_buy_signal_simple(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_simple.value == True) &
    ...
    def get_buy_signal_strategy001(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_strategy001.value == True) &
    ...
    def get_buy_signal_technical_example_strategy(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_technical_example_strategy.value == True) &
            (dataframe['cmf'] < 0)
        )
        return signal
    ...
    def get_buy_signal_tema_rsi_strategy(self, dataframe: DataFrame):
        signal = (
            (self.buy_enable_signal_tema_rsi_strategy.value == True) &
