...
"""
####################################################################################
TS_Simple_AB - subclass of TS_Simple that uses an AdaBoost Gradient model

####################################################################################
"""


class TS_Simple_AB(TS_Simple):
    ...
    def create_model(self, df_shape):
        ...
        print("    creating AdaBoostRegressor")
        params = {'n_estimators': 100, 'learning_rate': 0.1, 'loss': 'square'}
