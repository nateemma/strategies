...
class TS_Simple(IStrategy):
    ...
    training_mode = False # set to true to generate initial model (typically over long time period)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Bollinger Bands
        bollinger = qtpylib.bollinger_bands(dataframe['future_gain'], window=20, stds=2)
        ...
        # dataframe['model_gain'] = 100.0 * (dataframe['predicted_gain'] - dataframe['future_gain']) / dataframe['future_gain']
    ...
    def get_predictions(self, dataframe: DataFrame):
        ...
        self.training_labels = gain_data[self.lookahead:]
    ...
    def add_rolling_predictions(self, dataframe: DataFrame):
        ...
        dataframe['predicted_gain'] = pred_array
    ...
    def add_jumping_predictions(self, dataframe: DataFrame) -> DataFrame:
        ...
        while end < nrows:
            ...
            train_data = self.training_data[train_start:start-1]
            train_results = self.training_labels[train_start:start-1]
        ...
        dataframe['future_gain'] = gain_data
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: 'datetime', current_rate: float,
        ...
        if (current_profit > 0) and (last_candle['model_gain'] <= self.exit_model_gain.value):
            return 'predict_drop'
