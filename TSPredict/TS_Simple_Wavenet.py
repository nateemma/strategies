...
from NNPredict.NNPredictor_Wavenet import NNPredictor_Wavenet
...
"""
####################################################################################
TS_Simple_Wavenet - subclass of TS_Simple that uses an Wavenet model

####################################################################################
"""


class TS_Simple_Wavenet(TS_Simple):
    ...
    def create_model(self, df_shape):
        ...
        self.model = NNPredictor_Wavenet(self.curr_pair, self.seq_len, self.num_features)
