...
from GANs.mt_label_wrappers import _UnflattenedGenerateWrapper
...
class NNMTStrategy(BaseNNStrategy):
    ...
    # the GAN-augmented strategy bases). Subclasses with richer classifier
    # wiring override _apply_classifier_overrides; the 3-D preprocess hooks
    # call these.
    # -----------
