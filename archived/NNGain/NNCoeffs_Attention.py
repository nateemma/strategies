...
"""
####################################################################################
NNCoeffs_Attention - uses a Attention neural network to try and predict the future stock price
...
class NNCoeffs_Attention(NNCoeffs):


    predictor_type = NNPredictors.PredictorType.ATTENTION
