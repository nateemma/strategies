...
"""
####################################################################################
NNCoeffs_COL_MLP - uses a MLP neural network to try and predict the future stock price
...
class NNCoeffs_COL_MLP(NNCoeffs):

      wavelet_type: Wavelets.WaveletType = Wavelets.WaveletType.DWTA # need to use smaller set of coeffs
      predictor_type = NNPredictors.PredictorType.COLUMNAR_MLP
