...
"""
####################################################################################
NNCoeffs_CNN - uses a CNN neural network to try and predict the future stock price
...
class NNCoeffs_CNN(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.CNN
