...
"""
####################################################################################
NNCoeffs_TCN - uses a TCN neural network to try and predict the future stock price
...
class NNCoeffs_TCN(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.TCN
