...
"""
####################################################################################
NNCoeffs_Transformer - uses a Transformer neural network to try and predict the future stock price
...
class NNCoeffs_Transformer(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.TRANSFORMER
