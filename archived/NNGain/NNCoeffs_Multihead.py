...
"""
####################################################################################
NNCoeffs_Multihead - uses a Multihead neural network to try and predict the future stock price
...
class NNCoeffs_Multihead(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.MULTIHEAD
