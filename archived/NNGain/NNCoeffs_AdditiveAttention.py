...
"""
####################################################################################
NNCoeffs_AdditiveAttention. - uses a AdditiveAttention. neural network to try and predict the future stock price
...
class NNCoeffs_AdditiveAttention(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.ADDITIVE_ATTENTION
