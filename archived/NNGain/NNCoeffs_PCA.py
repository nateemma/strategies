...
"""
####################################################################################
NNCoeffs_PCA - uses a PCA neural network to try and predict the future stock price
...
class NNCoeffs_PCA(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.PCA
