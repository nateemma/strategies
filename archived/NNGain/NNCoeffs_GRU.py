...
"""
####################################################################################
NNCoeffs_GRU - uses a GRU neural network to try and predict the future stock price
...
class NNCoeffs_GRU(NNCoeffs):

    predictor_type = NNPredictors.PredictorType.GRU
