...
"""
####################################################################################
NNCoeffs_Encoder - uses a Encoder neural network to try and predict the future stock price
...
class NNCoeffs_Encoder(NNCoeffs):

      seq_len = 1
      predictor_type = NNPredictors.PredictorType.ENCODER
