...
"""
####################################################################################
Predict_LSTM2 - uses an LSTM (triple layered) neural network to try and predict the future stock price
...
class NNPredict_LSTM3(NNPredict):

    predictor_type = NNPredictors.PredictorType.LSTM3
