...
*WARNING:* I had to upgrade Tensorflow and Keras to get around a Tensorflow bug. Keras 3.x changed pretty significantly, and in a non backward-compatible way (thanks, keras team). So, the latest versions will only work with keras 3.x - sorry
