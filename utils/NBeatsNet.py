...
from tensorflow.keras.layers import Input, Dense, Lambda, Subtract, Add, Reshape # type: ignore
...
class NBeatsNet:
    ...
    def __getattr__(self, name):
        ...
        def wrapper(*args, **kwargs):
            ...
            return getattr(self.models[cast_type], attr.__name__)(*args, **kwargs) # type: ignore
