...
'''
Bolinger Band Reversion to Mean
'''
class BBRevert(SimpleStrategy):
    ...
    def get_entry_signals(self, dataframe):
        ...
        bollinger = qtpylib.bollinger_bands(dataframe['close'], window=int(self.entry_period.value), stds=2)
        dataframe['bb_lowerband'] = bollinger['lower']
        dataframe['bb_middleband'] = bollinger['mid']
        dataframe['bb_upperband'] = bollinger['upper']

        # close moves away from bb_lowerband
        series = np.where(
            (
